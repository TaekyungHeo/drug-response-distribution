...
from utils.PASO_DrugSensitivityDataset_GEP import OmicsDrugSensitivityDataset_GEP
...
def main(
    ...
    model_name = params.get("model_fn", "PASO_GEP_NON_ATT")
...
if __name__ == "__main__":
    ...
    train_sensitivity_filepath = '../../../data/data_reproduce/drug_sensitivity_MixedSet_test.csv'
    test_sensitivity_filepath = '../../../data/data_reproduce/drug_sensitivity_MixedSet_test.csv'
    ...
    params_filepath = '../../../data/best_hyp/proposed_model/PASO_GEP_Non_Attention.json'
    training_name = 'without_att_Testing'
    # run the training
    main(
        train_sensitivity_filepath,
        test_sensitivity_filepath,
