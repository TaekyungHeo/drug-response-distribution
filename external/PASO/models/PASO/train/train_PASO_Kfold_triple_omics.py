...
from utils.PASO_DrugSensitivityDataset_GEP_CNV_MUT import OmicsDrugSensitivityDataset_GEP_CNV_MUT
...
def main(
    ...
    for fold in range(n_folds):
        ...
        model_name = params.get("model_fn", "PASO_GEP_CNV_MUT")
...
if __name__ == "__main__":
    ...
    drug_sensitivity_filepath = 'data/10_fold_data/mixed/10fold/MixedSet_'
