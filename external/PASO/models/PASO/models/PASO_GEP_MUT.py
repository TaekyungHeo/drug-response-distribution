...
class PASO_GEP_MUT(nn.Module):
    ...
    def __init__(self, params, *args, **kwargs):
        ...
        super(PASO_GEP_MUT, self).__init__(*args, **kwargs)
    ...
    def forward(self, smiles, gep, mut, confidence=False):
        """
        Args:
        ...
        (encodings, smiles_alphas_gep, smiles_alphas_mut,
         gene_alphas, mut_alphas) = [], [], [], [], []
        for layer in range(len(self.molecule_gep_heads)):
            for head in range(self.molecule_gep_heads[layer]):
