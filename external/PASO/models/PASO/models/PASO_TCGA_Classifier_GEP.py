...
class PASO_GEP_TCGA_Classifier(nn.Module):

    def __init__(self, params, *args, **kwargs):

        super(PASO_GEP_TCGA_Classifier, self).__init__(*args, **kwargs)
        ...
        # Transformer Encoder Encode, drugs using transformer -> Learn global drug features for each drug molecule.
        ...
        # Final dense layer,could be linear or sigmoidal(classification,0 or 1)
        self.final_dense = (
