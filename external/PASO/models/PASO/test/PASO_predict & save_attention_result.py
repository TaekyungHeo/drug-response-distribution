...
def main(
    ...
    model_name = params.get("model_fn", "PASO_GEP_V2")
...
if __name__ == "__main__":
    ...
    model_path = 'models/TRANS_MCA_GEP_V2_Lung_CellBlind_AttLayerReBuild/weights/best_mse_PASO_GEP_V2.pt'
    params_filepath = 'models/TRANS_MCA_GEP_V2_Lung_CellBlind_AttLayerReBuild/TCGA_classifier_best_aucpr_GEP.json'
