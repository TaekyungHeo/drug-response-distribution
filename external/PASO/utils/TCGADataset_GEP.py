...
class TCGADataset_GEP(Dataset):
    def __init__(self,
                 ...
                 column_names: Tuple[str] = ['drug', 'bcr_patient_barcode', 'response'],
                 padding: bool = True,
    ...
    def __getitem__(self, index):
        ...
        return (token_indexes_tensor, gene_expression_tensor, response_tensor)
